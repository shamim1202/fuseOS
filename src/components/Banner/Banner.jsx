  ...
  return (
    <div>
      <div className="md:w-3xl md:mx-auto text-center">
        <h1 className="text-4xl md:text-6xl font-semibold opacity-85 md:py-8 md:leading-16">
          One Platform To
          <br />
          <span className="text-[#8AD63F] md:font-bold">Discover</span> Apps
        </h1>
        <p className="text-[#626b82] text-sm md:text-base">
      ...
      {/* Apps Market Button */}
      <div className="flex items-center justify-center gap-2 md:gap-4 md:py-8">
        <button className="text-[#001931] text-sm md:text-base md:font-bold flex items-center justify-center gap-2">
          <img
